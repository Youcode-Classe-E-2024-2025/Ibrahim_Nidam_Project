...
<body class="flex flex-col w-screen h-screen overflow-auto text-gray-200 bg-gradient-to-tr from-[#2a464e] via-[#243b42] to-[#1d2b31]">
    ...
    <div class="px-10 mt-6">
        <h1 class="text-2xl font-bold">Manage Categories and Tags for Project: <?= htmlspecialchars($_GET["name"]) ?></h1>
                        ...
                        <tbody>
                            <?php foreach ($categories as $category): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <a href="?action=editCategory&id=<?= $category['id'] ?>&project_id=<?= $_GET['id'] ?>" class="text-indigo-600 hover:text-indigo-800">Edit</a> |
                                        <a href="?action=deleteCategory&id=<?= $category['id'] ?>&project_id=<?= $_GET['id'] ?>" class="text-red-600 hover:text-red-800">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        ...
                        <tbody>
                            <?php foreach ($tags as $tag): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <a href="?action=editTag&id=<?= $tag['id'] ?>&project_id=<?= $_GET['id'] ?>" class="text-indigo-600 hover:text-indigo-800">Edit</a> |
                                        <a href="?action=deleteTag&id=<?= $tag['id'] ?>&project_id=<?= $_GET['id'] ?>" class="text-red-600 hover:text-red-800">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
        ...
        <div class="mt-6">
            <a href="?action=addCategory&project_id=<?= $_GET['project_id'] ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Add Category</a>
            <a href="?action=addTag&project_id=<?= $_GET['project_id'] ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 ml-4">Add Tag</a>
        </div>
    </div>
