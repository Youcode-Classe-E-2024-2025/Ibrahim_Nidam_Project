...
<body class="flex flex-col w-screen h-screen overflow-auto text-gray-200 bg-gradient-to-tr from-[#2a464e] via-[#243b42] to-[#1d2b31]">
    ...
    <h1 class="text-2xl font-bold">Manage Categories and Tags : <span class="underline"><?= $_GET["name"]?></span></h1>
                ...
                <tbody>
                    <tr>
                        <td class="border border-gray-300 px-4 py-2">
                            <form action="?action=addTagOrCategory&project_id=<?=$_GET["project_id"]?>&name=<?=$_GET["name"]?>" method="post">
