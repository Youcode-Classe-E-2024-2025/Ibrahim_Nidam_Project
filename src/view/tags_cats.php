...
<body class="flex flex-col w-screen pb-5 min-h-screen overflow-auto text-gray-200 bg-gradient-to-tr from-[#2a464e] via-[#243b42] to-[#1d2b31]">
    <div class="flex justify-between flex-shrink-0 w-full h-16 px-10 bg-white bg-opacity-75">
        <div class="flex items-center">
            ...
            <input class="flex items-center h-10 px-4 ml-10 text-sm bg-gray-200 rounded-lg focus:outline-none focus:ring" type="search" placeholder="Search for anything…">
            <div class="ml-10">
